...
namespace Bomberman {
    ...
    void Window::addTestLabel() {
        centralWidget = new QWidget(
                this);                  //documentation says central widget is necessary even if it's just a placeholder
        centralWidget->setObjectName("centralWidget");
        setCentralWidget(centralWidget);

        verticalLayout = new QVBoxLayout(
                centralWidget);    //layout which keeps widget nicely centered when resizing window
